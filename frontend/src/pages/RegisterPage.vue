    ...
    >
      <aside class="rounded-[1.5rem] border border-ink bg-[#fffaf0] p-6 md:p-8">
        ...
        <p class="mt-5 max-w-sm text-base font-medium leading-7 text-ink/68">
          Регистрация сразу задает роль. Для исполнителя дальше появится профиль, портфолио, навыки
          и RPG-roadmap уровня доверия.
        </p>
      </aside>

      <section class="rounded-[1.5rem] border border-ink bg-ink p-5 text-paper sm:p-8">
