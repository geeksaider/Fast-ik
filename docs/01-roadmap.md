...
- XP-бонус за отзыв заказчика после завершенного заказа;
- средний рейтинг исполнителя влияет на требования уровней Reliable/Pro;
- уведомление при повышении уровня;
- `GET /api/levels/me`;
- страница `/level-roadmap`;
- требования уровней: профиль, навыки, портфолио, выбранные заявки, завершенные заказы, отзывы, рейтинг, отсутствие активных споров, HR-интервью для Elite.
