...
## Блок 7.6. Публичный профиль исполнителя

Статус: готово, базовый слой.

Цель:

- показать заказчику надежность исполнителя до первого сообщения;
- связать RPG-уровень, рейтинг, отзывы, навыки и портфолио в одной публичной витрине;
- дать вход в профиль из откликов и завершенных заказов.

Сделано:

- `GET /api/performers/:id`;
- страница `/performers/:id`;
- публичная карточка уровня, XP, рейтинга, завершенных заказов и отзывов;
- блоки навыков, ставки, формата работы и портфолио;
- отзывы заказчиков с оценкой и датой;
- имя исполнителя в откликах и заказе ведет в публичный профиль;
- demo seed наполняет профиль исполнителя навыками и портфолио.
