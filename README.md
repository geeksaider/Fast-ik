...
- XP начисляется за отклик, выбранную заявку, сдачу работы, завершенный заказ и отзыв заказчика.
- отзывы после завершенного заказа, рейтинг исполнителя и влияние оценки на RPG-прогресс.
- публичный профиль исполнителя `/performers/:id`: уровень, рейтинг, отзывы, навыки и портфолио.
